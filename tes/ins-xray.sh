...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/nginx.conf.txt" 
...
sleep 1 
wget -q -O xray.conf https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/xray.conf.txt && chmod +x xray.conf && ./xray.conf
sleep 1
