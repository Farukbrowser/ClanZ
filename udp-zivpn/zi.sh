...
wget https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/udp-zivpn/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
...
echo -e "Installed in ClanZ by Farukbrowser"
