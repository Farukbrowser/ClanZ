...
wget -O /usr/local/bin/edu-proxy https://raw.githubusercontent.com/Farukbrowser/websocket/main/https.py && chmod +x /usr/local/bin/edu-proxy
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/Insshws/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/Insshws/ws-stunnel.txt
...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/Insshws/service-wsdropbear.txt && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/Insshws/ws-stunnel.service.txt && chmod +x /etc/systemd/system/ws-stunnel.service
