...
sleep 1
wget -q -O xraymode.sh https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O /etc/xray/config.json "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/configuration/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/configuration/xray.conf"
