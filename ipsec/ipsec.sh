...
mkdir /var/lib/crot
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
wget -O /var/lib/crot/data-user-l2tp "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/l2tp-user.sh"
wget -O /var/lib/crot/data-user-pptp "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/pptp-user"
