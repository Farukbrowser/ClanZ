...
#	SCRIPT:				ShellBot.sh
#	VERSÃO:				6.4.0
#	DESENVOLVIDO POR:	Faruk Browser [24clan.COM]
#	PÁGINA:				https://www.24clan.com
#	FANPAGE:			https://www.facebook.com/farukbrowser0
#	GITHUB:				https://github.com/farukbrowser
# 	CONTATO:			farukbrowser0@gmail.com
#
...
#							  
#							https://github.com/farukbrowser/ShellBot/wiki
#
...
[author]='Faruk Browser [24clan.COM]'
[email]='farukbrowser0@gmail.com'
[wiki]='https://github.com/farukbrowser/shellbot/wiki'
[github]='https://github.com/farukbrowser/shellbot'
...
ShellBot.init()
{
    ...
    ShellBot.sendMessage()
    {
        ...
        # Variables with null values are ignored and consequently their parameters omitted.
    	jq_obj=$(curl $_CURL_OPT_ POST $_API_TELEGRAM_/${FUNCNAME#*.} \
									${chat_id:+-d chat_id="$chat_id"} \
									${text:+-d text="$text"} \
