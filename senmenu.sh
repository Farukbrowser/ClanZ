...
wget -q -O /usr/bin/infosc "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/limit/info.sh" && chmod +x /usr/bin/infosc
wget -q -O /usr/bin/pelanggar "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/limit/pelanggar.sh" && chmod +x /usr/bin/pelanggar

wget -q -O /root/status "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/statushariini"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/menu.sh"
wget -q -O /usr/bin/delv2ray "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/tes/delv2ray.sh"
...
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/running.sh"
...
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/tes/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/tes/menu-vmess.sh"
#wget -q -O /usr/bin/menu-socks "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-socks.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/tes/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/tes/menu-trojan.sh"
...
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/menu/usernew.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/menu.sh"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/issue.net"
wget -q -O /root/versi "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/versibasic"
wget -q -O /usr/bin/updatsc "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/menu/update.sh"
wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/menu-backup.sh"
wget -q -O /usr/bin/fix "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/cf.sh"
wget -q -O /usr/bin/setting "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/Themes/setting.sh"
wget -q -O /usr/bin/menu-ipsec "https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/ipsec/menu-ipsec.sh"
wget https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/autoscript-ssh-slowdns-main/wslow.sh
wget https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/backup/set-br.sh
bash set-br.sh
wget https://raw.githubusercontent.com/Farukbrowser/ClanZ/main/Themes/thema.sh
wget https://raw.githubusercontent.com/Farukbrowser/FrkCHAT_BOT/main/3d.flf
